...
public class MainFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button docButton = (Button) view.findViewById(R.id.DoctorBtn);
        docButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_mainFragment_to_doctorFragment);
            }
        });

        Button patientBtn = (Button) view.findViewById(R.id.PatientBtn);
        ...
        Button psfBtn = (Button) view.findViewById(R.id.PsfButton);
